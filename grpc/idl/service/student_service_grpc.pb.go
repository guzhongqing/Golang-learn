...
import (
	context "context"
	model "golang_learn/go_basic/grpc/idl/model"
...
func RegisterStudentServer(s grpc.ServiceRegistrar, srv StudentServer) {
	// If the following call panics, it indicates UnimplementedStudentServer was
